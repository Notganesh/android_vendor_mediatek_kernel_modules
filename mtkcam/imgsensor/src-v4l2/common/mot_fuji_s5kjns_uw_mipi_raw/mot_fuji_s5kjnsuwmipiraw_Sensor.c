 ...
 *============================================================================
 ****************************************************************************/
#include "mot_fuji_s5kjnsuwmipiraw_Sensor.h"
...
static struct subdrv_mode_struct mode_struct[] = {
	{
		...
		.mode_setting_table = addr_data_pair_preview_mot_fuji_s5kjns_uw,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_preview_mot_fuji_s5kjns_uw),
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = MOT_FUJI_S5KJNS_UW_SENSOR_ID,
...
const struct subdrv_entry mot_fuji_s5kjns_uw_mipi_raw_entry = {
	.name = "mot_fuji_s5kjns_uw_mipi_raw",
	.id = MOT_FUJI_S5KJNS_UW_SENSOR_ID,
	.pw_seq = pw_seq,
...
{
	DRV_LOG(ctx, "E\n");
	DRV_LOG(ctx, "MOT fuji S5KJNS_UW init start\n");
	...
	i2c_table_write(ctx, addr_data_pair_init_mot_fuji_s5kjns_uw,
			ARRAY_SIZE(addr_data_pair_init_mot_fuji_s5kjns_uw));
	DRV_LOG(ctx, "MOT fuji S5KJNS_UW init end\n");
	DRV_LOG(ctx, "X\n");
}
